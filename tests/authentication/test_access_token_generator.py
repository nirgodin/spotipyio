...
from spotipyio.consts.api_consts import GRANT_TYPE, JSON, CODE, REDIRECT_URI, REFRESH_TOKEN, CLIENT_ID, ACCESS_TOKEN, \
...
class TestAccessTokenGenerator:
    ...
    async def test_generate__client_credentials(self,
    ...
    async def test_generate__authorization_code(self,
                                                redirect_uri: str,
                                                expected_headers: Dict[str, str],
                                                authorization_server: HTTPServer,
                                                access_token_generator: AccessTokenGenerator):
    ...
    async def test_generate__refresh_token(self,
                                           client_id: str,
                                           expected_headers: Dict[str, str],
                                           authorization_server: HTTPServer,
                                           access_token_generator: AccessTokenGenerator):

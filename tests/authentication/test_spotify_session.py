...
class TestSpotifySession:
    ...
    async def test_aenter__no_cache_handler__creates_headers_using_token_request(self,
    ...
    async def test_refresh__no_cache_handler__creates_headers_using_token_request(self,
                                                                                  session_without_cache: SpotifySession,
                                                                                  mock_cache_handler: MagicMock,
                                                                                  grant_type: SpotifyGrantType,
                                                                                  access_code: str,
    ...
    async def session(self,
                ...
                mock_cache_handler: MagicMock,
                grant_type: SpotifyGrantType,
                access_code: str) -> SpotifySession:
        session = SpotifySession(
    ...
    @fixture
    async def session_without_cache(self,
                              mock_token_generator: AsyncMock,
                              grant_type: SpotifyGrantType,
                              access_code: str) -> SpotifySession:
        session = SpotifySession(

...
class TestSearchItemCollector:
    async def test_run_single__valid_response__returns_expected_response(
        self, spotify_client: SpotifyClient, test_client: SpotifyTestClient
    ):
    ...
    async def test_run__all_invalid_responses__returns_empty_list(
        self, invalid_search_items: List[SearchItem], test_client: SpotifyTestClient, spotify_client: SpotifyClient
    ):
    ...
    @staticmethod
    def _given_all_responses_valid(
        search_items_responses_map: List[Tuple[SearchItem, dict]], test_client: SpotifyTestClient
    ) -> None:
